...
categorical_features = categorical_features.drop('NObeyesdad')  # Exclude the target variable if it is in the categorical features
...
features = pd.concat([numerical_features, data_encoded], axis=1)
