...
# plot_pca_2d(data_normalized, predicted_labels_dbscan, 'PCA of Student Evaluation Data with DBSCAN Clusters', 'pca_clusters_DBSCAN.png')
...
print(f'Time taken: {end_time - start_time} seconds')
# plot_pca_2d(data_normalized, predicted_labels_meanshift, 'PCA of Student Evaluation Data with Mean Shift Clusters', 'pca_clusters_MeanShift.png')
...
print(f'Time taken: {end_time - start_time} seconds')
# plot_pca_2d(data_normalized, predicted_labels_hdbscan, 'PCA of Student Evaluation Data with HDBSCAN Clusters', 'pca_clusters_HDBSCAN.png')
...
print(f'Time taken: {end_time - start_time} seconds')
# plot_pca_2d(data_normalized, predicted_labels_quickshift, 'PCA of Student Evaluation Data with QuickShift Clusters', 'pca_clusters_QuickShift.png')
