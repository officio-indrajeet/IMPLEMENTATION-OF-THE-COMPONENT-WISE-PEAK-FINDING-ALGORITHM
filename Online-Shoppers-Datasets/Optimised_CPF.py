...
if __name__ == '__main__':
    ...
    np.random.seed(42)
    # Assuming 5 clusters for synthetic labels
    true_labels = np.random.randint(0, 5, size=data_preprocessed.shape[0])
...
# Function to calculate and print clustering metrics
    ...
    def print_clustering_metrics(true_labels, predicted_labels):
        ...
        silhouette_avg = silhouette_score(
            data_preprocessed[valid_indices], predicted_labels)
    ...
    cpf_model.fit(data_preprocessed)
    end_time = time.time()
    ...
    # Plot PCA results
    # plot_pca_2d(data_preprocessed, predicted_labels_cpf, 'PCA of Engagement Metrics with CPF Clusters', 'pca_clusters_CPF.png')
